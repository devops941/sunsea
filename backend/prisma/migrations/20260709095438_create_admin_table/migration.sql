...
-- CreateEnum
CREATE TYPE "public"."MachineStatus" AS ENUM ('IDLE', 'RUNNING', 'BREAKDOWN', 'MAINTENANCE');
...
-- CreateEnum
CREATE TYPE "public"."ItemCategoryType" AS ENUM ('RAW_MATERIAL', 'FINISHED_GOODS', 'SEMI_FINISHED');
...
-- AddForeignKey
ALTER TABLE "public"."weekly_machine_programs" ADD CONSTRAINT "weekly_machine_programs_machine_id_fkey" FOREIGN KEY ("machine_id") REFERENCES "public"."machines"("machine_id") ON DELETE RESTRICT ON UPDATE CASCADE;
