...
export const bulkUpsertAttendanceSchema = z.object({
  body: z.object({
    ...
    records: z.array(z.object({
      ...
      otAmount:            z.number().min(0).default(0).optional(),
      otDays:              z.number().min(0).default(0),
      otDaysAmount:        z.number().min(0).default(0).optional(),
      teaOtCount:          z.number().int().min(0).default(0),
      teaOtAmount:         z.number().min(0).default(0).optional(),
      lateMinutes:         z.number().int().min(0).default(0),
      lateDeduction:       z.number().min(0).default(0).optional(),
      permissionMinutes:   z.number().int().min(0).default(0),
      permissionDeduction: z.number().min(0).default(0).optional(),
