...
//     <div className="px-4 py-2.5 bg-card-2/60 border-b border-line-soft">
//       <h6 className="text-xs font-bold text-ink uppercase tracking-[1.5px]">{title}</h6>
//     </div>
...
//             {/* Right: Image Uploads */}
//             <div className="lg:w-[240px] lg:border-l border-t lg:border-t-0 border-line-soft/50 p-5 lg:p-6 flex lg:flex-col items-center  gap-10">
