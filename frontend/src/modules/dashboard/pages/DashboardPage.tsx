    ...
    <div className="inner-container bg-light">
      <Container fluid className="py-4">
        ...
        <div className="d-flex justify-content-between align-items-end mb-4">
          <div>
            <h2 className="fw-bold mb-1" style={{ color: 'var(--color-primary, #0D9488)' }}>Manufacturing Command Center</h2>
            <div className="text-muted">Centralized overview of your entire ERP operations</div>
          </div>
          {anyLoading && (
            <div className="text-muted small d-flex align-items-center">
              <Spinner animation="border" size="sm" className="me-2" /> Syncing Data...
            </div>
          )}
        </div>
        ...
        <Row className="g-4 mb-4">
          ...
          {/* 6. Production Status & Priority (Half width if xl, full if lg) */}
