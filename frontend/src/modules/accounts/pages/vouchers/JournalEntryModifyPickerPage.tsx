          ...
          <form id="modify-picker-form" onSubmit={handleSubmit} className="p-4 space-y-2.5 text-[13px]">
            ...
            <div className="grid grid-cols-12 gap-3 items-center">
              ...
              <div className="col-span-7">
                <input
                  ...
                  placeholder="e.g. 3"
                  className="w-full px-2 py-1 border border-line bg-slate-900 text-white rounded text-[13px] font-mono font-semibold focus:ring-1 focus:ring-purple-500/40 focus:border-purple-500 focus:outline-none"
                />
              </div>
            </div>
            ...
            <div className="pt-2 flex justify-center">
              <button
                type="submit"
                disabled={submitting}
                className="px-6 py-1 bg-purple-600 hover:bg-purple-700 text-white rounded font-semibold text-[13px] transition cursor-pointer disabled:opacity-50"
              >
