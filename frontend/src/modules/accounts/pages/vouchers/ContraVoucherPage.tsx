...
import { FaExchangeAlt, FaPlus, FaSearch, FaChevronLeft, FaChevronRight } from "react-icons/fa";
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      const res = await voucherService.fetchVouchers({
        type: "CONTRA", startDate: filterDate || undefined, endDate: filterDate || undefined,
