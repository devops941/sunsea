          ...
          <div className="px-3 py-2 border-b border-line grid grid-cols-12 gap-x-2 gap-y-1.5 text-[13px] items-center">
            ...
            <div className="col-span-11">
              <input
                ...
                className={`w-full px-2 py-1 border border-line bg-card rounded text-[13px] text-ink focus:ring-1 focus:ring-purple-500/40 focus:border-purple-500 focus:outline-none ${ACTIVE_CELL}`}
              />
            </div>
          </div>
