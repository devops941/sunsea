          ...
          <div className="px-3 py-2 border-b border-line grid grid-cols-12 gap-x-3 gap-y-1.5 text-[11px] items-center">
            ...
            <div className="col-span-4">
              <input
                ...
                className={`w-full px-2 py-1 border border-line bg-card rounded text-[11px] text-ink focus:ring-1 focus:ring-emerald-500/40 focus:border-emerald-500 focus:outline-none ${ACTIVE_CELL}`}
              />
            </div>
