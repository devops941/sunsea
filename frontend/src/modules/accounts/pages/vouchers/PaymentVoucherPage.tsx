      ...
      <div className="bg-card rounded-lg border border-line px-3 py-2 flex flex-wrap items-center gap-2">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <input
            ...
            className="w-[130px] px-2 py-1 border border-line bg-card rounded text-xs text-ink focus:ring-1 focus:ring-red-500/40 focus:border-red-500 focus:outline-none"
          />
        </div>
        ...
        <div className="relative w-full max-w-[320px]">
          <input
            ...
            className="w-full pl-7 pr-2 py-1 border border-line bg-card rounded text-xs text-ink focus:ring-1 focus:ring-red-500/40 focus:border-red-500 focus:outline-none"
          />
