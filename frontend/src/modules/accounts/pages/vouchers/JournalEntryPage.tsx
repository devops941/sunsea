...
import { FaBookOpen, FaPlus, FaSearch, FaChevronLeft, FaChevronRight } from "react-icons/fa";
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      const res = await voucherService.fetchVouchers({
        type: "JOURNAL", startDate: filterDate || undefined, endDate: filterDate || undefined,
    ...
    <div className="p-3 space-y-3 bg-card-2 min-h-screen">
      ...
      <div className="bg-card rounded-lg border border-line">
        <div className="flex items-center justify-between gap-2 px-3 py-2 border-b border-line">
          ...
          <button onClick={() => navigate("/accounts/journal-entry/add")}
          ...
          <div className="flex-1 min-w-[180px]">
            ...
            <div className="relative">
              <input type="text" placeholder="Voucher no or narration..." value={searchTerm}
                ...
                className="w-full pl-7 pr-2 py-1.5 border border-line bg-card rounded text-xs text-ink focus:ring-1 focus:ring-purple-500/40 focus:border-purple-500 focus:outline-none" />
