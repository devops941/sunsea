...
const OPTIONS_KEY = "sunsea:receivable:options:v4";
...
const AmountReceivablePage: React.FC = () => {
  ...
  const COL_WIDTHS_KEY = "sunsea:receivable:colWidths:v1";
...
// F5 = refresh (centralised via usePageShortcuts).  usePageShortcuts({ onRefresh: refresh });
  ...
  useEffect(() => {
    const onKey = (e: KeyboardEvent) => {
      ...
      //   - From table view   → open Options modal (current filters pre-loaded)
