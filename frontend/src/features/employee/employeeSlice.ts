...
export const fetchEmployees = createAsyncThunk("employees/fetchAll", async (params: { search?: string; designationId?: string | number; page?: number; limit?: number } | undefined, { rejectWithValue }) => {
  try {
