...
export const employeeService = {
  fetchAll: async (params?: { search?: string; departmentId?: string | number; roleId?: string | number; status?: string; includeDrafts?: boolean; page?: number; limit?: number; sortBy?: string; sortOrder?: "asc" | "desc" }): Promise<any> => {
