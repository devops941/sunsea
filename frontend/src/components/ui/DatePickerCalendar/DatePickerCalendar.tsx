    ...
    <div ref={containerRef} className="relative w-full font-sans mb-[18px] group">
      ...
      <div className="relative">
        ...
        <button
          ...
          disabled={disabled}
          onClick={() => setOpen((o) => !o)}
          className={`flex w-full h-[35px] items-center justify-between rounded-[10px] border px-4 text-[15px] font-medium transition-all duration-250 outline-none text-left
            ${error
