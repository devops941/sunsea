...
export const DocumentPrintLayout: React.FC<DocumentPrintLayoutProps> = ({
    ...
    return (
        <div
            id={id}
            className="font-sans text-black bg-white border-2 border-black w-full min-h-[262mm] flex flex-col box-border"
        >
            <div className="text-center border-b-2 border-black py-[15px] px-[10px] shrink-0">
